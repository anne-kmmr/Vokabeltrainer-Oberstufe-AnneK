...
<body>
	...
	<script src="Sonstige-Scripte-u.-Vokabeln/TooltipFunktion.js"></script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            showInfoBox("Hier gehts´s zu Anmeldung. Danke, dass du dich dafür anmeldest!", 4000);
    ...
    <div class="container">
        <h1>Jetzt für unseren Sprachtacular-Newsletter anmelden!</h1>
        <p>Erhalte die neusten Informationen als Email in dein Postfach!</p>

        <form action="Vokabeltrainer-Newsletter-Script.php" method="post">
            ...
            <small>
                <p>Wenn du dich nicht mehr angemeldet sein möchtest, kannst du dich jederzeit <a href="Vokabeltrainer-Newsletter-Abmeldung.php">hier abmelden</a>.</p>
            </small>
    </div>
    <br>
    <br>
