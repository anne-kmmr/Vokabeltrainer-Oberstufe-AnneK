...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $vocabList[] = array("word" => $row["deutsch"], "translation" => $row["englisch"]);
    }
}
...
<body>
    ...
    <div class="container">
        ...
        <div class="right-container">
            ...
            <div class="standard-controls">
                ...
                <div class="tooltip">
                    <img src="Eingebundene-Bilder/Vokabeltrainer-Vokabeln-Icon-Weiter.png" alt="Weiter" onclick="nextVocab()">
                    <span class="tooltiptext">Weiter</span>
                </div>
            </div>
        </div>
    </div>
	...
	<script>
        ...
        function updateProgressBar() {
            const progress = ((learnedList.length + (totalVocabCount - repeatList.length)) / totalVocabCount) * 100;
        ...
        function nextVocab() {
            if (repeatList.length > 0) {
                const learnedVocab = repeatList.splice(currentVocabIndex, 1)[0];
                learnedList.push(learnedVocab);
                ...
                const currentCard = document.querySelector('.vocab-card');
